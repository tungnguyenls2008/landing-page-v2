...
/*!********************************************************!*\
  !*** ./resources/metronic/js/pages/layout/services.js ***!
  \********************************************************/
 // Class definition
...
var KTDatatableHtmlTableDemo = function () {
  ...
  var demo = function demo() {
    var datatable = $('#kt_datatable_services').KTDatatable({
      data: {
        saveState: {
          cookie: false
        }
    ...
    $('#kt_datatable_services').on("click", ".delete", function (e) {
      e.preventDefault();
      var id = $(this).data('id');
      Swal.fire({
        ...
        if (result.value) {
          ...
          var sendUri = HOST_URL + "/layout/service-list/" + id;
          $.ajax({
            url: sendUri,
            method: 'DELETE',
    ...
    $('#kt_datatable_services').on("click", ".edit", function (e) {
      e.preventDefault();
      var id = $(this).data('id');
      $(".page-loader").addClass("bg-dark-o-50");
      $("#kt_body").addClass("page-loading");
