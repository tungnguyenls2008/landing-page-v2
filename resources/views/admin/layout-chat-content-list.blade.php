...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/chat-content-list.js') }}"></script>
@endsection
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">{{ __('Chat Content') }}</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="javascript:;" class="text-muted">{{ __('Chat Content') }}</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Chat Content') }}</h3>
                            </div>
                            <!--begin::Form-->
                            ...
                            <div class="card-body">
                                ...
                                <table class="datatable table-hover datatable-bordered datatable-head-custom"
                                    ...
                                    <tr>
                                        ...
                                        <th title="Field #3" class="big-col">Answer</th>
