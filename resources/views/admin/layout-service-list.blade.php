...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/services.js') }}"></script>
@endsection
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">{{ __('Services') }}</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="javascript:;" class="text-muted">{{ __('Service') }}</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.service-list.add') }}" method="POST">
                                    @csrf
                                    <div id="add_services" class="p-8 border-primary border-1" style="border-style: dotted;">
                                ...
                                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_services">
                                    <thead>
                                    <tr>
                                        <th title="Field #1">#</th>
                                        <th title="Field #2">Name</th>
                                        <th title="Field #3">Name (AR)</th>
                                        <th title="Field #4">Order</th>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="{{ route('admin.layout.service-list.edit') }}" method="POST">
                        @csrf
