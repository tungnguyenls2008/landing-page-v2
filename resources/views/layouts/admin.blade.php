            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item {{ Route::current()->getName() == 'admin.layout.general' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('admin.layout.general') }}" class="menu-link">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item {{ Route::current()->getName() == 'admin.layout.visitor-list' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('admin.layout.visitor-list') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">{{ __('Visitors') }}</span>
                            </a>
                        </li>
                    </ul>
                    <ul class="menu-nav">
                        <li class="menu-section">
                            <h4 class="menu-text">{{ __('Chat History') }}</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item {{ Route::current()->getName() == 'admin.layout.chat-list' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            <a href="{{ route('admin.layout.chat-list') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">{{ __('Chat History') }}</span>
                            </a>
                        </li>
                    </ul>
                    <!--end::Menu Nav-->
